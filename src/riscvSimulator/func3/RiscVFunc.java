...
public enum RiscVFunc {
	...
	sw(RiscVOpCode.store,0b0000000,0b001),
	...
	srai(RiscVOpCode.opimm,0b0000000,0b101),
	...
	private RiscVFunc(RiscVOpCode OpCode,int Func3CodeValue,int Func7CodeValue) {
